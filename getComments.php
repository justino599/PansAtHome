...
try {
    ...
    $sql = "select * from comment where postId = :id and (text like :search or username like :search) order by upvotes - downvotes desc";
    $stmt = $pdo->prepare($sql);
    $stmt->execute([':id' => $_GET['postId'], ':search' => '%' . $search . '%']);
    ...
    foreach ($comments as $comment) {
        ...
        echo '
        <div class="comment" id="' . htmlentities($commentId) . '">
            <div class="pfp-line">
